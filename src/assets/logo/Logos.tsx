...
export function AppStore(){
    return(
        <SvgIcon>
            <svg data-v-16285074="" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                 aria-hidden="true" role="img" className="icon" width="20px" height="20px" viewBox="0 0 512 512">
                <path
...
export function GooglePlay(){
    return <SvgIcon>
        <svg data-v-16285074="" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
             aria-hidden="true" role="img" className="icon" width="20px" height="20px" viewBox="0 0 24 24">
            <path fill="currentColor"
                  d="M3 20.5v-17c0-.59.34-1.11.84-1.35L13.69 12l-9.85 9.85c-.5-.25-.84-.76-.84-1.35m13.81-5.38L6.05 21.34l8.49-8.49zm3.35-4.31c.34.27.59.69.59 1.19s-.22.9-.57 1.18l-2.29 1.32l-2.5-2.5l2.5-2.5zM6.05 2.66l10.76 6.22l-2.27 2.27z"></path>
        </svg>
    </SvgIcon>
}